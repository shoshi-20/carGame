...
//===============יצירת ומחיקת המכוניות שיורדות מלמעלה והמטבעות================================
...
function roading() {
    ...
    var imgDollarSrc = '../images/coin/coin1.png';
...
//=========================התנגשות עם מטבעות וצבירת נקודות מהם===========================================
...
function localStorege() {
    if (localStorage.level2 == null)
        localStorage.level2 = p;
    else if (localStorage.level2 < p) {
        localStorage.level2 = p;
    }
    else {
        localStorage.level2 = localStorage.level2;
    }
    document.getElementById("score").innerHTML = localStorage.level2;
}
